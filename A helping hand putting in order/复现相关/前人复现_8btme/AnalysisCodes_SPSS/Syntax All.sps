...
USE ALL.
COMPUTE filter_$=(Accur = 1 & RT < 672).
VARIABLE LABELS filter_$ 'Accur = 1 & RT < 672 (FILTER)'.
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'.
FORMATS filter_$ (f1.0).
FILTER BY filter_$.
EXECUTE.
...
COMPUTE Corrected.Supine.Index=Up.Index - Down.Index.
EXECUTE.

COMPUTE Corrected.Supine.little=Up.Little - Down.Little.
EXECUTE.

COMPUTE Corrected.Supine.middle=Up.Middle - Down.Middle.
EXECUTE.

COMPUTE Corrected.Supine.ring=Up.Ring - Down.Ring.
EXECUTE.

COMPUTE Corrected.Supine.thumb=Up.Thumb - Down.Thumb.
EXECUTE.


* instead of: COMPUTE Corrected.Supine.Index=U.index.Corrected - D.index.Corrected.
*EXECUTE.
...
USE ALL.
COMPUTE filter_$=(Accuracy = 1 & RT < 1125).
VARIABLE LABELS filter_$ 'Accuracy = 1 & RT < 1125 (FILTER)'.
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'.
FORMATS filter_$ (f1.0).
FILTER BY filter_$.
EXECUTE.
...
AGGREGATE
  /OUTFILE='D:\Reaserch\OSF\OSF 2\Original materials\Agg experimental all.sav'
...
COMPUTE Corr.D.thumb=D.thumb - Corrected.Supine.thumb.
EXECUTE.

COMPUTE Corr.D.index=D.index - Corrected.Supine.index.
EXECUTE.

COMPUTE Corr.D.middle=D.middle - Corrected.Supine.middle.
EXECUTE.

COMPUTE Corr.D.ring=D.ring - Corrected.Supine.ring.
EXECUTE.

COMPUTE Corr.D.little=D.little - Corrected.Supine.little.
EXECUTE.



COMPUTE Corr.G.thumb=G.thumb - Corrected.Supine.thumb.
EXECUTE.

COMPUTE Corr.G.index=G.index - Corrected.Supine.index.
EXECUTE.

COMPUTE Corr.G.middle=G.middle - Corrected.Supine.middle.
EXECUTE.

COMPUTE Corr.G.ring=G.ring - Corrected.Supine.ring.
EXECUTE.

COMPUTE Corr.G.little=G.little - Corrected.Supine.little.
EXECUTE.


COMPUTE Corr.H.thumb=H.thumb - Corrected.Supine.thumb.
EXECUTE.

COMPUTE Corr.H.index=H.index - Corrected.Supine.index.
EXECUTE.

COMPUTE Corr.H.middle=H.middle - Corrected.Supine.middle.
EXECUTE.

COMPUTE Corr.H.ring=H.ring - Corrected.Supine.ring.
EXECUTE.

COMPUTE Corr.H.little=H.little - Corrected.Supine.little.
EXECUTE.
...
COMPUTE E=MEAN(E.thumb, E.index, E.middle, E.ring, E.little).
EXECUTE.
